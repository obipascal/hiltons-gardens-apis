...
class FavoritesApis extends Controller
{
	use RESTResponse;
	/**
	...
	public function index()
	{
		try {
			...
			$handler = Handlers::Favorites(request())->fetchFavorites();
	...
	public function store(Request $request)
	{
		try {
			...
			/* Call the controller handlers to handle request logic */
			$handler = Handlers::Favorites($request)->addToFavorite();
	...
	public function destroy(string $id)
	{
		try {
			...
			/* Call the controller handlers to handle request logic */
			$handler = Handlers::Favorites(request())->removeFavorite($id);
