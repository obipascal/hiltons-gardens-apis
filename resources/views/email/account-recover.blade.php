                                        ...
                                        <tr>
                                            <td align="left" style="padding:10px;Margin:0">
                                                <p
                                                    ...
                                                    We've noticed you're experiencing difficulty signing in to your
                                                    <strong>Hilton Garden's</strong> account. To facilitate the reset of
                                                    your account password, kindly enter the code below to confirm your
                                                    identity.
                                                    <br />
                                                    <br />
                                                    Ignore this email if this action was not initiated by you.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
