...
<table class="es-footer" cellspacing="0" cellpadding="0" align="center" role="none"
    ...
    <tr>
        <td align="center" bgcolor="#efefef" style="padding:0;Margin:0;background-color:#efefef">
            <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none"
                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                <tr>
                    <td class="es-m-p5" align="left" bgcolor="#efefef"
                        style="padding:0;Margin:0;background-color:#efefef">
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                        ...
                                        <tr>
                                            <td align="center" class="es-m-txt-c"
                                                ...
                                                <table border="0" width="60%" height="100%" cellpadding="0"
